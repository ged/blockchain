# -*- encoding: utf-8 -*-
# stub: blockchain 0.1.pre20171226172254 ruby lib

Gem::Specification.new do |s|
  s.name = "blockchain".freeze
  s.version = "0.1.pre20171226172254"
  ...
  s.files = [".document".freeze, ".editorconfig".freeze, ".rdoc_options".freeze, ".simplecov".freeze, "ChangeLog".freeze, "History.md".freeze, "LICENSE.txt".freeze, "Manifest.txt".freeze, "README.md".freeze, "Rakefile".freeze, "lib/blockchain.rb".freeze, "lib/blockchain/currency.rb".freeze, "lib/blockchain/ledger.rb".freeze, "lib/blockchain/proof_of_work.rb".freeze, "spec/blockchain/proof_of_work_spec.rb".freeze, "spec/blockchain_spec.rb".freeze, "spec/spec_helper.rb".freeze]
  s.homepage = "http://repo.deveiate.org/Blockchain".freeze
